...
- dotaheor, "[View generic as compile-time calls with multiple element outputs - v2](https://gist.github.com/dotaheor/c805d221ed86265d6e8bb4f16a714060)", January 2019 (last update: Feb 2019). Now `import` and `generic` output are supported. (This version supports the contract part but not the generic part in draft.)
