# IDEs and Plugins for Go
  ...
  * **[Source Insight](https://www.sourceinsight.com)**: Commercial (with 30 days trail) programming editor & code browser with built-in live analysis for C/C++, C#, Java, and more; helping you understand large projects.
